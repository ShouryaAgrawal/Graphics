...
box1.position.y = groundMesh.position.y+0.05+1;
box2.position.y = box1.position.y+(3.5/2);
box3.position.y = box2.position.y+(2.5/2);
box4.position.y =box3.position.y+0.6;
